...
<head>
    ...
    <title>Registration For Instructor</title>
...
<div class="font-[sans-serif] bg-white md:h-screen">
      <div class="grid md:grid-cols-2 items-center gap-8 h-full">
        ...
        <div class="flex items-center p-6 h-full w-full">
          <form class="max-w-lg w-full mx-auto" action="/register/instructor" method="POST">
            <div class="mb-12">
              <h3 class="text-blue-500 md:text-3xl text-2xl font-extrabold max-md:text-center">Create an account</h3>
            </div>

            <div>
              <label class="text-gray-800 text-xs block mb-2" for="username">Username</label>
              <div class="relative flex items-center">
                <input name="username" type="text" required class="w-full bg-transparent text-sm border-b border-gray-300 focus:border-blue-500 px-2 py-3 outline-none" placeholder="Enter name" />
            ...
            <div class="mt-6">
              <label class="text-gray-800 text-xs block mb-2" for="email">Email</label>
              <div class="relative flex items-center">
            ...
            <div class="mt-12">
              ...
              <p class="text-sm mt-6 text-gray-800">Already have an account? <a href="/login" class="text-blue-500 font-semibold hover:underline ml-1">Login here</a></p>
            </div>
          </form>
        </div>
      </div>
