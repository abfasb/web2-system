    ...
    <div class="h-screen pt-16 w-full">
     <aside id="default-sidebar" class="fixed top-30 mt-14 h-full z-40 w-64" aria-label="Sidenav">
      <div class="overflow-y-auto py-5 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        <ul class="space-y-2">
          <li>
              <a href="/course-pilot/instructor/" class="flex items-center p-2 bg-green-600 text-white text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-green-800 dark:hover:bg-gray-700 group">
                  <svg aria-hidden="true" class="w-6 h-6 text-black transition duration-75 dark:text-gray-400 hover:text-white dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path><path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path></svg>
...
<main class="p-8 ml-[300px] w-[1200px] pl-14 flex justify-center items-center">
    <div class="bg-white w-50 dark:bg-gray-800 p-6 rounded-lg shadow-md" style="width:1280px; margin-left:250px;">
    <div class="flex items-center justify-between mb-12">
            <h4 class="text-4xl font-bold text-gray-800 dark:text-gray-200">Dashboard</h4>
            <div class="flex items-center space-x-4">
                <button class="bg-indigo-600 text-white py-2 px-4 rounded-lg hover:bg-indigo-700">
                   <a href="/course-pilot/instructor/courses">Add New Course</a>
                </button>
            </div>
    ...
    <?php foreach ($courses as $course): ?>
        <a href="/course-pilot/instructor/assignments?course_id=<?= $course['course_id'] ?>" 
            class="bg-white border border-gray-200 p-6 rounded-xl shadow-lg hover:shadow-2xl hover:scale-105 transform transition-transform duration-300 ease-in-out">
            
            <h3 class="text-lg font-bold text-gray-900 mb-3"><?= htmlspecialchars($course['title']) ?></h3>
            
            <p class="text-sm text-gray-600 mb-2">
                <span class="font-semibold text-indigo-600">Date Added:</span> <?= date('M d, Y', strtotime($course['created_at'])) ?>
            </p>
            
            <p class="text-sm text-gray-600 mb-2">
                <span class="font-semibold text-indigo-600">Course Code:</span> <?= htmlspecialchars($course['course_code']) ?>
            </p>
