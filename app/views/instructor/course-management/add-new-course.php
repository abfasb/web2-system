     ...
     <aside id="default-sidebar" class="fixed top-30 mt-14 h-full z-40 w-64" aria-label="Sidenav">
      <div class="overflow-y-auto py-5 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        <ul class="space-y-2">
          ...
          <li>
              <button type="button" class="flex items-center p-2 w-full bg-green-600 text-white text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-green-800 dark:text-white" aria-controls="dropdown-pages" data-collapse-toggle="dropdown-pages">
...
<main class="p-8 ml-[300px] min-h-screen flex justify-center items-center" style = "width: 1200px; margin-left: 290px;">
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md w-full max-w-3xl">
        <div class="flex items-center flex-col justify-between mb-12">
            <h4 class="text-4xl font-bold text-gray-800 dark:text-gray-200">Add New Course</h4>
        </div>

        <form action="/course-pilot/instructor/add-course" method="POST" class="space-y-6">
            <div>
                <label for="title" class="block text-lg font-medium text-gray-700 dark:text-gray-300 mb-2">
                    Course Title
                </label>
                <input
                    type="text"
            ...
            <div class="flex items-center space-x-4 pb-2">
                <div class="flex-grow">
                    <label for="course_code" class="block text-lg font-medium text-gray-700 dark:text-gray-300 mb-2">
                        Course Code
                    </label>
                    <input
                        type="text"
                ...
                <button
                    ...
                    class="bg-indigo-600 text-white px-4 py-2 rounded-lg shadow hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800" style = "margin-top:30px; padding:10px 20px;"
                >
                    Generate Code
                </button>
            </div>
